...
namespace PlayerControl
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		[Header("Footstep Sounds")]
			...
			// AudioSource is _footstepSource
			[SerializeField] private AudioSource _footstepSource;

			[Tooltip("The footstep sounds audio clip")]
			// Audioclip[] is _footstepSounds
		...
		private void HandleMovement()
		{
			...
			_isMoving = _verticalInput != 0 || _horizontalInput != 0;
		...
		private void HandleGravityAndJumping()
		{
			...
			if (_characterController.isGrounded)
			{
				...
				} // close  if Input GetKeyDown jumpKey
		...
		private void PlayFootstepSounds()
		{
			...
			} // cloe  if _footstepSounds Length 1
